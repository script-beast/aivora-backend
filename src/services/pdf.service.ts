...
export class PDFService {
  ...
  private addHeader(): void {
    ...
    this.doc.rect(0, 0, this.pageWidth, 80).fill("#4F46E5");

    this.doc
      .rect(0, 80, this.pageWidth, 15)
      .fillAndStroke("#6366F1", "#4F46E5");

    // Logo/Title with spark icon
    this.doc
      .fontSize(32)
      .font("Helvetica-Bold")
      .fillColor("#FFFFFF")
      .text("✨ Aivora", this.margin + 10, this.currentY + 15);

    this.doc
      .fontSize(12)
      .font("Helvetica")
      .fillColor("#E0E7FF")
      .text("Goal Achievement Report", this.margin + 10, this.currentY + 48);
    ...
    for (let i = 0; i < totalPages; i++) {
      ...
      this.doc
        ...
        .text(
          ...
          footerY + 8,
          {
            width: this.pageWidth - 2 * this.margin - 60,
            align: "center",
          }
        );

      // Page number badge
      const pageNumX = this.pageWidth - this.margin - 45;
      this.doc
        .roundedRect(pageNumX, footerY + 6, 40, 16, 8)
        .fillAndStroke("#E0E7FF", "#6366F1");
      ...
      this.doc
        ...
        .font("Helvetica-Bold")
        .fillColor("#4338CA")
        .text(`${i + 1}/${totalPages}`, pageNumX, footerY + 10, {
          width: 40,
          align: "center",
        });
    }
